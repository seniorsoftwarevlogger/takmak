...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		XXXXXXX, MO(2),   KC_A,      KC_S,     KC_D,    KC_F,    KC_G,   XXXXXXX,  KC_BSPC, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_BSLS,
		XXXXXXX, KC_LSFT, KC_Z,      KC_X,     KC_C,    KC_V,    KC_B,                      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_UP,   KC_LSFT,
		XXXXXXX, MO(1),   XXXXXXX,   KC_LCTRL, KC_LALT, KC_LGUI,         KC_SPC,   KC_ENT,           KC_RGUI, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT),

	[1] = LAYOUT(
		XXXXXXX, _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______,   _______,  KC_F6,   KC_F7, KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
		XXXXXXX, _______, _______, _______, _______, _______, _______, _______,   KC__MUTE, _______, KC_7,  KC_8,    KC_9,    _______, _______, _______,
